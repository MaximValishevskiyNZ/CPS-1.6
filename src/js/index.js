...
const burger = document.querySelector('.circle-button--bg-img--menu')
const cross = document.querySelector('.circle-button--bg-img--cross')
...
const repairsSwiper = document.querySelector(".repairs__swiper");
const feedbackMessage = document.querySelector(".modal--feedback--message");
const feedbackMessageOpen = document.querySelector(".circle-button--bg-img--message");
...
const feedbackPhoneOpen = document.querySelector(".circle-button--bg-img--phone");
...
toggleAsideActiveOnOpen(navigation, burger, cross, wrapper, body);
